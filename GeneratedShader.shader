	...
	SubShader
	{
		...
		Pass
		{
			...
			#include "LightweightLighting.cginc"
							...
							float4 _PBRMaster_595E6C50_Albedo;
							float4 _PBRMaster_595E6C50_Normal;
							float4 _PBRMaster_595E6C50_Emission;
							...
							SurfaceDescription PopulateSurfaceData(SurfaceInputs IN) {
								...
								surface.Albedo = _PBRMaster_595E6C50_Albedo;
								surface.Normal = _PBRMaster_595E6C50_Normal;
								surface.Emission = _PBRMaster_595E6C50_Emission;
