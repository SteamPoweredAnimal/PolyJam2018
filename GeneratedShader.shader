	...
	SubShader
	{
		...
		Pass
		{
			...
			#include "LightweightLighting.cginc"
							...
							float4 _PBRMaster_319A1619_Albedo;
							float4 _PBRMaster_319A1619_Normal;
							float4 _PBRMaster_319A1619_Emission;
							float _PBRMaster_319A1619_Metallic;
							float _PBRMaster_319A1619_Smoothness;
							float _PBRMaster_319A1619_Occlusion;
							float _PBRMaster_319A1619_Alpha;
							GraphVertexInput PopulateVertexData(GraphVertexInput v){
								return v;
							}
							SurfaceDescription PopulateSurfaceData(SurfaceInputs IN) {
								SurfaceDescription surface = (SurfaceDescription)0;
								surface.Albedo = _PBRMaster_319A1619_Albedo;
								surface.Normal = _PBRMaster_319A1619_Normal;
								surface.Emission = _PBRMaster_319A1619_Emission;
								surface.Metallic = _PBRMaster_319A1619_Metallic;
								surface.Smoothness = _PBRMaster_319A1619_Smoothness;
								surface.Occlusion = _PBRMaster_319A1619_Occlusion;
								surface.Alpha = _PBRMaster_319A1619_Alpha;
								return surface;
							}
